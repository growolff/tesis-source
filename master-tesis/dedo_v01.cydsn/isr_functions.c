...
CY_ISR(SPD_COMMAND_INT)
{
    ...
    if(PM1.control_mode == 1 || PM1.control_mode == 2){
        ...
        //MOTOR_commandDriver(&PM1,PMF,(uint8)(fn_mapper_8b(PM1.spdPID_out,0,9500,0,255)));
    }
...
CY_ISR(TNS_COMMAND_INT)
{
    ...
    if(PM1.control_mode == 3){
        ...
        MOTOR_commandDriver(&PM1,PMF,(int)fn_mapper_8b(fabs(PM1.tension_control_signal),0,4096,0,255));
    }
